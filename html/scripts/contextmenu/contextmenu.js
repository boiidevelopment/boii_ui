...
const menu_options = [
    {
        ...
        action: 'myResource:option1Event',
        params: {},
        disabled: false
    },
    {
        header: 'Option 2',
        message: 'Example text<br>on multi-lines',
        action_type: 'server_event',
        action: 'myResource:option2Event',
        params: {},
        disabled: false
    },
    {
        header: 'Option 3',
        header_icon: '<i class="fa-solid fa-shield-halved"></i>',
        message: 'Example text<br>on multi-lines with a header icon',
        action_type: 'server_event',
        action: 'myResource:option3Event',
        params: {},
        disabled: false
    },
    {
        ...
        message: 'Example text<br>on multi-lines with a header icon<br>and an image',
        message_icon: '<i class="fa-solid fa-shield-halved"></i>',
        action_type: 'server_event',
        action: 'myResource:option4Event',
        params: {},
        disabled: false
    }
];
...
context_menu.create_menu('default', menu_data);
*/