class ContextManager {
    constructor() {
        this.default_style = { background: '#1f1e1e', border_size: '3px', border_style: 'solid', border_colour: '#b4b4b4', border_radius: '15px', text_colour: '#b4b4b4', animation: '1s', box_shadow: '2px 2px 5px #0d0c0c, -2px -2px 5px #2b2a2a' };
        this.custom_style = {};
        this.data = null;
